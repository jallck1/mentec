...
urlpatterns = [
    ...
    path('clients', views.ClientView.as_view({'get':'get_all_clients','post':'post_clients'})),
    path('clients/<int:id>', views.ClientView.as_view({'delete':'delete_cliente'})),
    path('images/<str:image_name>', views.ImageView.as_view({'get':'get_file_img'})),
